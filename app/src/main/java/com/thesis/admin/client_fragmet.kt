 ...
 * Use the [client_fragmet.newInstance] factory method to
 * create an instance of this fragment.
 */
class client_fragmet : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
           ...
           /* view.findViewById<Button>(R.id.addnewuser).setOnClickListener {
                val i = Intent(activity, Ne::class.java)
    ...
    override fun onCreateView(
       ...
       // return inflater.inflate(R.layout.fragment_client_fragmet, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment client_fragmet.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            client_fragmet().apply {
